...
<body x-data="{ isTop: true }" class="state1 background-100-e">
    ...
    <!-- Modal New Search -->
    <div id="modal-new-search" class="modal-new-search">
        <span class="modal-new-search-close">&times;</span>
        <div class="modal-new-search-content">
            <p style="font-variant: small-caps;">new <span style="color: yellow;">SEARCH</span> feature above!</p>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="pages/archive.php" class="hover-effect">Videos</a></li>
                ...
                <ul>
                    <li>
                        ...
                        <ul>
                            ...
                            <li><a target="_blank" href="https://stedfastbaptistkjv.org/">Brother Dillon Awes of Stedfast Baptist Church</a>, <a target="_blank" href="https://goo.gl/maps/hY9v3Q1WZDDo7vYF8">Hurst, TX</a></li>
