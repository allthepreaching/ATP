        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="#boldmen" class="hover-effect">Bold Men</a></li>
                    <li><a href="#whoweare" class="hover-effect">We Are</a></li>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6  col-xs-6">
                            ...
                            <div class="caption">
                                <p>
                                    <span class="title">Brother Matthew Stucky</span>
                                    <br />
                            ...
                            <div class="text-right scroll-in-animation" data-animation="fadeInLeft">
                                <p class="big-font">
                                    <b>
                                        ...
                                        <br />
                                        <a target="_blank" href="docs/Vaccine_Letter_Shield_Of_Faith.pdf">Shield of Faith Baptist, ID</a>
                                        <br />
                                        <a target="_blank" href="docs/Vaccine_Letter_Stedfast.pdf"><span class="highlight">Stedfast Baptist, TX</span></a>
                                        <br />
                                        <a target="_blank" href="docs/Vaccine_Letter_Stronghold.pdf">Stronghold Baptist, GA</a>
                                        <br />
                            ...
                            <form id="form1" action="https://formspree.io/f/xwkwzqon" method="post">
                                ...
                                <div class="elem-group">
                                    <label for="message">Let us know if you have any questions or if there are any other churches that we could request a letter from to list here on the site.
                                        <br>
                                        <span class="highlight">(If you would like a reply back please leave an email in the message below.)</span>
                                        <br>
                                        Thank you!
                                    </label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="text-right scroll-in-animation" data-animation="fadeInLeft">
                                <p class="big-font">
                                    <b>
                                        <a href="mailto:admin@allthepreaching.com">admin@allthepreaching.com</a><br />
