...
<div class="video-container paused" data-volume-level="high">
    ...
    <div id="video-controls-container" class="video-controls-container">
        ...
        <div class="controls">
            ...
            <!-- Rewind Button -->
            <button class="rewind-btn" title="( &larr; )">
            ...
            <!-- Play Pause Button -->
            <button class="play-pause-btn" title="( Space / K )">
            ...
            <!-- Fast Forward Button -->
            <button class="forward-btn" title="( &rarr; )">
                <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 -960 960 960" width="24">
            ...
            <!-- Captions Container -->
            <button class="captions-btn" title="( C )">
            ...
            <!-- Theater Mode -->
            <button class="theater-btn" title="( T )">
            ...
            <!-- Full Screen -->
            <button class="fullscreen-btn" title="( F )">
